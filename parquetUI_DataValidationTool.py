...
uplinkColsForCSV =      {   'AGGR' : ['AGGR_uplinkbytebuffer','AGGR_uplinkflowbuffer','uplinkcostbuffer'],
                            'PEAK' : ['uplinkbytebuffer','uplinkflowbuffer','uplinkcostbuffer']    }
downlinkColsForCSV =    {   'AGGR' : ['AGGR_downlinkbitbuffer','AGGR_downlinkbytebuffer','AGGR_downlinkflowbuffer','downlinkcostbuffer'],
                            'PEAK' : ['downlinkbytebuffer','downlinkflowbuffer','downlinkcostbuffer']    }
upDownlinkColsForCSV =  {   'AGGR' : ['AGGR_totalByteBuffer','AGGR_totalflowbuffer','totalcostbuffer','AGGR_uplinkbytebuffer','AGGR_downlinkbytebuffer'],
                            'PEAK' : ['PEAK_totalByteBuffer','PEAK_totalflowbuffer','totalcostbuffer','PEAK_uplinkbytebuffer','PEAK_downlinkbytebuffer']    }
    ...
    for record in rawData:
        if re.match('^[0-9]',record):
            ...
            if 'transitbuffer' in processedDataPerRecord.keys() and processedDataPerRecord['transitbuffer'] != '' and 'FFFFFFFFFFFFFFFF' not in processedDataPerRecord['transitbuffer']:
                ...
                if len(processedDataPerRecord['transitbuffer']) >32:
                    pass
...
if __name__ == '__main__':
        ...
        # SITE
        createScreenDataFile('sourcesiteid','sourcesitetypeid=1',rawData_f_nrmca_60min_3600_sitedatacube,columns_f_nrmca_60min_3600_sitedatacube,'AGGR_downlinkbytebuffer',binInterval)
        ...
        # createScreenDataFile('timestamp;sourcesiteelementtypeid','sourcesitetypeid=1;sourcesiteid=22',rawData_f_nrmca_60min_3600_sitedatacube,columns_f_nrmca_60min_3600_sitedatacube,'timestamp',binInterval)
        ...
        # createScreenDataFile('timestamp;destsiteelementtypeid','sourcesiteelementtypeid=15;sourcesitetypeid=1;sourcesiteid=22;destsiteid=14;destsitetypeid=1',rawData_f_nrmca_60min_3600_siteflowdatacube,columns_f_nrmca_60min_3600_siteflowdatacube,'timestamp',binInterval)
