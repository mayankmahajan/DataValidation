...
FH=open('/Users/mayank.mahajan/f_nrmca_60min_3600_routerinterfacestatscube_dump1')
...
FH=open('/Users/mayank.mahajan/1month')
...
FH=open('/Users/mayank.mahajan/vrf')
    ...
    for record in rawData:
        if re.match('^[0-9]',record):
            ...
            if 'uplinkbytebuffer' in processedDataPerRecord.keys():
                ...
                processedDataPerRecord['PEAK_uplinkbitbuffer'] = map(lambda x:(x*8/300), eval(processedDataPerRecord['uplinkbytebuffer']))
                processedDataPerRecord['PEAK_downlinkbitbuffer'] = map(lambda x:(x*8/300), eval(processedDataPerRecord['downlinkbytebuffer']))
                processedDataPerRecord['PEAK_totalbitbuffer'] = map(add,processedDataPerRecord['PEAK_uplinkbitbuffer'], processedDataPerRecord['PEAK_downlinkbitbuffer'])
            ...
            for eachKey in processedDataPerRecord.keys():
                ...
                if type(processedDataPerRecord[eachKey]) is list:
                    if len(processedDataPerRecord[eachKey])>1 :
                        ...
                        # temp fix
                        processedDataPerRecord['PEAK_'+eachKey] = processedDataPerRecord[eachKey]
                    else:
            ...
            # temp
            processedDataPerRecord['PEAK_totalByteBuffer'] = map(add,processedDataPerRecord['PEAK_uplinkbytebuffer'],processedDataPerRecord['PEAK_downlinkbytebuffer'])
            ...
            # temp
            processedDataPerRecord['PEAK_totalflowbuffer'] = map(add,processedDataPerRecord['PEAK_uplinkflowbuffer'],processedDataPerRecord['PEAK_downlinkflowbuffer'])
...
if __name__ == '__main__':
        ...
        # # SITE
        # createScreenDataFile('sourcesiteid','sourcesitetypeid=1',rawData_f_nrmca_60min_3600_sitedatacube,columns_f_nrmca_60min_3600_sitedatacube,'downlinkbytebuffer',binInterval)

        # # SITE TO VRF
        # createScreenDataFile('vrfid','sourcesitetypeid=1;sourcesiteid=3581',rawData_f_nrmca_60min_3600_siteflowdatacube,columns_f_nrmca_60min_3600_siteflowdatacube,'AGGR_uplinkbytebuffer',binInterval)
        createScreenDataFile('vrfid','sourcesitetypeid=1;sourcesiteid=17;destsiteid=25;destsitetypeid=1',rawData_f_nrmca_60min_3600_siteflowdatacube,columns_f_nrmca_60min_3600_siteflowdatacube,'PEAK_downlinkbytebuffer',binInterval)
        ...
        # SITE TO NE
        # createScreenDataFile('sourcesiteelementtypeid','sourcesitetypeid=1;sourcesiteid=22;sourcesiteelementtypeid=15',rawData_f_nrmca_60min_3600_sitedatacube,columns_f_nrmca_60min_3600_sitedatacube,'AGGR_downlinkbytebuffer',binInterval)
        # createScreenDataFile('sourcesiteelementtypeid','sourcesitetypeid=2;sourcesiteid=249',rawData_f_nrmca_60min_3600_sitedatacube,columns_f_nrmca_60min_3600_sitedatacube,'AGGR_downlinkbytebuffer',binInterval)
        ...
        # createScreenDataFile('interface','router=1061;interface=2',rawData_f_nrmca_60min_3600_routerinterfacestatscube,columns_f_nrmca_60min_3600_routerinterfacestatscube,'AGGR_downlinkbytebuffer',binInterval)

        # columns_f_nrmca_60min_3600_routerinterfacestatscube
